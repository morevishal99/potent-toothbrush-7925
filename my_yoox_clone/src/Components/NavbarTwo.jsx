...
function NavbarTwo() {
    ...
    //                     <div id='nilesh'>
    //                         <div>
    //                         <Text as='b' fontSize='md' >Face</Text>
    //                             <ul>
    ...
    //                             <ul>
    //                             <Text as='b' fontSize='md' ><Link to='/eyes'>Eyes</Link></Text>
    //                                 <li> Kajal</li>
    //                                 <li> Eyeliner</li>
    //                                 <li> Mascara</li>
    //                                 <li> Eye Shadow</li>
    ...
    //                                 <li> Multi-Functional Makeup Palettes</li>
    //                             </ul>
        ...
        < div id="main" >
            <div class='navbar'>
                    ...
                    <ul  class='navbartop'>
                      ...
                      <li>REGISTER</li>
                      {/* <li onClick={handleclclick()}>LOGIN</li> */}
